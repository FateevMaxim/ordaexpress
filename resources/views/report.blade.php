            ...
            <div class="grid grid-cols-1 mx-auto md:grid-cols-1 h-22 pl-6 pr-6 pb-4">
                ...
                <form method="POST" action="{{ route('track_report') }}" class="mb-4">
                    <div class="grid grid-cols-6 md:grid-cols-6 gap-2 mb-6 ">
                        <div>
                            <input type="date" id="date" value="{{ $date }}" name="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
                        <div>
